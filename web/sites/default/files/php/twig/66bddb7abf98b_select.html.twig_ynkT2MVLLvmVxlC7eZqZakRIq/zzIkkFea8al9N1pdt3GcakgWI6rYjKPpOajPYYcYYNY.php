...
class __TwigTemplate_dcd3efa247d4274c884ec0a2f691b91c extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
        // line 31
        echo "  ";
        if ( !twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "offsetExists", ["multiple"], "method", false, false, true, 31)) {
            // line 32
...
$context["option"], "type", [], "any", false, false, true, 44) == "option")) {
  ...
  ";
        // line 50
        if ( !twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "offsetExists", ["multiple"], "method", false, false, true, 50)) {
            // line 51
            echo "    </div>
  ";
        }
  ...
  ";
        ...
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["input_group", "prefix", "attributes", "options", "suffix"]);    }
